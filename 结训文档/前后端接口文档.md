...
| disasterType | String | 是 | 灾害类型（earthquake/flood/landslide/debris_flow/fire/drought/typhoon/other） |
...
| status | String | 否 | 状态筛选（PENDING_VERIFY/CONFIRMED/PROCESSING/COMPLETED） |
...
| 字段 | 类型 | 必填 | 说明 |
|------|------|------|------|
| status | String | 是 | 目标状态（PENDING_VERIFY/CONFIRMED/PROCESSING/COMPLETED） |
